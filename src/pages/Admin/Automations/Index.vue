            ...
            <table class="min-w-full divide-y divide-[var(--esc-panel-border)]">
                ...
                <tbody class="divide-y divide-[var(--esc-panel-border)]">
                    ...
                    >
                        ...
                        <td class="px-4 py-3 text-sm text-[var(--esc-panel-text-tertiary)] max-w-xs truncate">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <span
                                :class="automation.active ? 'text-emerald-400' : 'text-[var(--esc-panel-text-muted)]'"
                                >{{ automation.active ? 'Yes' : 'No' }}</span
                            >
                        </td>
