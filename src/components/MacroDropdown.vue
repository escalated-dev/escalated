    ...
    <div class="relative">
        ...
        >
            <div
                v-if="open"
                :class="[
                    'absolute right-0 z-40 mt-1 w-64 overflow-hidden rounded-xl border shadow-xl',
                    escDark
                ...
                <div class="max-h-64 overflow-y-auto">
                    <div
                        ...
                        :class="[
                            ...
                            escDark ? 'text-[var(--esc-panel-text-muted)]' : 'text-gray-400',
                        ]"
                    >
                        No macros available
                    </div>
                    <button
                        ...
                        :class="[
                            ...
                            escDark
                                ? 'hover:bg-[var(--esc-panel-hover)] disabled:opacity-50'
                    ...
                    >
                        <span
                            :class="[
                                'text-sm font-medium',
                                escDark ? 'text-[var(--esc-panel-text-secondary)]' : 'text-gray-900',
                            ]"
                        >
                            {{ macro.name }}
                        </span>
