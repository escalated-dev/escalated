...
const selectClass = computed(() =>
    escDark.value
        ? 'rounded-lg border border-[var(--esc-panel-border-input)] bg-[var(--esc-panel-surface-alt)] px-2 py-1.5 text-sm text-[var(--esc-panel-text-secondary)] focus:border-[var(--esc-panel-border-input)] focus:outline-none focus:ring-1 focus:ring-[var(--esc-panel-border-input)]'
...
<template>
    ...
    >
        <div
            ...
            :class="[
                'fixed bottom-0 left-0 right-0 z-50 border-t px-6 py-3',
                escDark
                    ? 'border-[var(--esc-panel-border)] bg-[var(--esc-panel-surface-alt)]/95 backdrop-blur-xl'
        ...
        >
            <div class="mx-auto flex max-w-7xl items-center gap-4">
                ...
                <select
                    ...
                    :disabled="processing"
                    @change="
                        performAction('assign', $event.target.value);
                        $event.target.value = '';
                    "
                >
                ...
                <select
                    ...
                    :disabled="processing"
                    @change="
                        performAction('department', $event.target.value);
                        $event.target.value = '';
                    "
                >
                ...
                <button
                    ...
                    :disabled="processing"
                    @click="performAction('delete', null)"
                >
                    Delete
                </button>
                ...
                <button
                    :class="[
                        ...
                        escDark
                            ? 'text-[var(--esc-panel-text-tertiary)] hover:bg-[var(--esc-panel-hover)] hover:text-[var(--esc-panel-text-secondary)]'
