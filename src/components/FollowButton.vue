...
<template>
    <button
        ...
        :class="[
            ...
            escDark
                ? following
                    ? 'bg-cyan-500/15 text-[var(--esc-panel-text)] ring-1 ring-[var(--esc-panel-accent)]/20 hover:bg-cyan-500/25'
    ...
    >
        ...
        <span
            ...
            :class="[
                ...
                escDark
                    ? 'bg-[var(--esc-panel-hover)] text-[var(--esc-panel-text-tertiary)]'
