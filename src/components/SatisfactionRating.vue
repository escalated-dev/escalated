...
<template>
    <div
        :class="[
            ...
            escDark ? 'border-[var(--esc-panel-border)] bg-[var(--esc-panel-surface)]' : 'border-gray-200 bg-white',
        ]"
    >
        <h3 :class="['text-sm font-semibold', escDark ? 'text-[var(--esc-panel-text-secondary)]' : 'text-gray-900']">
        ...
        <div class="mt-3 flex items-center gap-1" @mouseleave="leaveStars">
            ...
            >
                ...
                <svg
                    ...
                    stroke-width="1.5"
                    viewBox="0 0 24 24"
                    :class="escDark ? 'text-[var(--esc-panel-text-muted)]' : 'text-gray-300'"
                >
                    <path
        ...
        <div v-if="isReadOnly && existingRating.comment" class="mt-3">
            <p :class="['text-sm italic', escDark ? 'text-[var(--esc-panel-text-tertiary)]' : 'text-gray-600']">
        ...
        <div v-if="!isReadOnly" class="mt-3">
            ...
            <button
                ...
                :class="[
                    ...
                    escDark
                        ? 'bg-gradient-to-r from-[var(--esc-panel-accent)] to-[var(--esc-panel-accent-secondary)] hover:from-[var(--esc-panel-accent-hover)] hover:to-[var(--esc-panel-accent-secondary-hover)]'
